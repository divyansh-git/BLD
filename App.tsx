...
import { CheckCircle, Zap, Menu, X, ArrowRight, Mail, Linkedin, Clock, Rocket, TrendingUp, Info, Shield, Gift, Calculator } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen text-white selection:bg-blue-500 selection:text-white cursor-auto md:cursor-none overflow-x-hidden">
      ...
      {calculatorOpen ? (
        <CostCalculator onClose={() => setCalculatorOpen(false)} />
      ) : (
        <>
      {/* Navigation */}
      ...
      <header className="relative min-h-[100svh] flex flex-col px-4 pt-24 pb-0 content-auto">
      ...
      {/* SERVICES GRID */}
      <section id="services" className="relative z-10 py-28 bg-slate-950 content-auto">
      ...
      {/* PROCESS SECTION */}
      <section id="process" className="relative z-10 py-28 bg-slate-900 border-t border-slate-800 overflow-hidden content-auto">
      ...
      {/* PRICING SECTION */}
      <section id="pricing" className="relative z-10 py-28 px-4 bg-slate-950 content-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-slate-900 to-slate-950 border border-blue-500/30 rounded-3xl p-8 md:p-14 shadow-[0_0_50px_rgba(59,130,246,0.1)]">
              <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="lg:w-1/3 flex flex-col justify-center items-center border-t lg:border-t-0 lg:border-l border-slate-800 pt-10 lg:pt-0 lg:pl-10">
                  <div className="w-full space-y-4 mb-8">
                    <div className="p-6 bg-slate-800/40 rounded-2xl border border-slate-700 text-center">
                      <div className="text-xs text-slate-500 font-bold uppercase mb-2 tracking-widest">Standard Pricing</div>
                      <div className="text-5xl font-bold text-white mb-1">$350</div>
                      <div className="text-xs text-slate-400">/profile /mo</div>
                    </div>
                  </div>
      ...
      <section className="relative z-10 py-28 bg-slate-900 border-t border-slate-800 content-auto">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Curious about the real cost of DIY?
          </h2>
          <p className="text-slate-400 text-lg mb-10 max-w-2xl mx-auto">
            Compare the raw software infrastructure costs of building a "Do It Yourself" cold outreach system versus hiring our managed service.
          </p>
          <button 
            onClick={() => {
            ...
            className="mx-auto px-10 py-5 bg-slate-800 border border-slate-700 rounded-2xl text-sm font-bold text-white hover:bg-slate-700 hover:border-blue-500 transition-all uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl hover:shadow-blue-500/20"
          >
            <Calculator className="w-5 h-5 text-blue-400" /> Compare DIY vs BLGS Costs
          </button>
        </div>
      </section>
