...
import { Users, CheckCircle, Zap, BarChart, Menu, X, ArrowRight, Mail, Linkedin, ChevronLeft, ChevronRight, Target, Server, Shield, Clock, Rocket, TrendingUp, Info } from 'lucide-react';
      ...
      <header className="relative min-h-[100svh] flex flex-col px-4 pt-24 pb-0">
        ...
        >
          ...
          <div className="relative w-full mb-8 text-center px-4">
            <GradientText as="h1" text="Multi-channel Lead Generation" className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.05] tracking-tight" />
          </div>
