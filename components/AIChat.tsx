...
const AIChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Hello. I am your LeadGen Assistant. How can I help you grow your business today?' }
  ]);
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="bg-gradient-to-r from-slate-800 to-slate-900 p-4 flex justify-between items-center border-b border-slate-700">
              ...
              <button onClick={() => setIsOpen(false)} className="text-slate-400 hover:text-white" data-hover="true">
                <X className="w-5 h-5" />
              </button>
            </div>
