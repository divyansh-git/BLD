          ...
          {FAQ_DATA.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative group bg-slate-800/40 border border-slate-700/50 rounded-2xl p-8 transition-all duration-300 hover:border-blue-500/50 hover:bg-slate-800/60 overflow-hidden cursor-pointer"
              >
                    ...
                    <h4 className="text-lg font-bold text-white mb-2 leading-tight group-hover:text-blue-400 transition-colors flex items-center gap-2">
                      ...
                      <ChevronRight 
                        className={`w-4 h-4 transition-all duration-300 ${
                          isOpen 
                            ? 'rotate-90 opacity-100 translate-x-0 text-blue-400' 
